...
export const MEDICATION_STATUS_CONFIG = {
  active: {
    label: "Active",
    className:
      "bg-[var(--green-bg)] text-[var(--green)] text-xs px-2 py-0.5 rounded-full font-medium",
  },
  completed: {
    label: "Completed",
  ...
  discontinued: {
    label: "Discontinued",
    className:
      "bg-[var(--danger-bg)] text-[var(--danger)] text-xs px-2 py-0.5 rounded-full font-medium",
  },
} as const;
