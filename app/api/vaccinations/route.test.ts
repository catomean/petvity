...
const MOCK_VACCINATION = {
  id: "vacc-1", petId: PET_ID, name: "Rabies", administeredDate: "2026-01-10",
  nextDueDate: "2027-01-10", status: "up_to_date",
};
...
const VALID_BODY = {
  petId: PET_ID, name: "Rabies", administeredDate: "2026-04-23",
};
